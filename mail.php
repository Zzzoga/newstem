...
if (!error_get_last()) {
    ...
    $title = "URALS GROUP";
    $body = "
    <h3>Заявка с сайта URALS GROUP</h3>
    <table>
            <tr>
    ...
    $mail->Username   = 'aurum.ufa@mail.ru'; // Логин на почте
    $mail->Password   = 'sMYAwxS0Uj9RqdVARQJp'; // Пароль на почте
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('aurum.ufa@mail.ru', 'URALS GROUP'); // Адрес самой почты и имя отправителя
